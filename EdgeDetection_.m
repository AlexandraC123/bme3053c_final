...
% load image into variable and process
img = input(prompt,'s');
img=[img,'.jpg'];
I=imread(img);
L1=figure;
...
imshow(BWsdil)
%masking to seprate tumor from brain border
%gets rid of brain border to avoid it getting filled
...
% calculate number of closed regions (tumors)
